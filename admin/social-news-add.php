              ...
              <div class="card-body">
                <form method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="post_type">
                                <option value="SOCIAL_NEWS" selected>SOCIAL_NEWS</option>
                            </select>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card-footer">
                      <button type="submit" name="add_social_news" class="btn btn-primary">Publish Post</button>
                    </div>
                  </form>
              </div>
            </div>
